...
CREATE TABLE IF NOT EXISTS `location` (
  ...
  `date_carte` varchar(5) NOT NULL,
  `cvv_carte` int(3) NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `location` (`id`, `userid`, `filmid`, `paiement_method`, `date_location`, `montant`, `duree_location`, `numero_carte`, `date_carte`, `cvv_carte`) VALUES
(1, 23, 23, 1, '2015-12-12', 0, 0, 2147483647, '12/12', 123),
(2, 23, 23, 1, '2015-12-12', 0, 0, 2147483647, '12/78', 123),
(3, 23, 24, 1, '2015-12-12', 0, 0, 2147483647, '12/22', 222),
(4, 23, 19, 1, '2015-12-12', 0, 0, 2147483647, '12/12', 122),
(5, 23, 6, 2, '2015-12-12', 0, 0, 2147483647, '12/45', 123);
...
(2, 'The Woman in Black 2 Angel of Death', NULL, NULL, NULL, 'Tom Harper', 130, 9, 2015),
(3, 'Taken 3', NULL, NULL, NULL, NULL, 125, 10, 2015),
(4, 'Cake', NULL, NULL, NULL, 'Daniel Barnz', 120, 8, 2015),
(5, 'Paper Planes', NULL, NULL, NULL, 'Robert Connolly', 138, 10, 2015),
...
(25, 'fff', 'rff', 'rafik', 'b2ca678b4c936f905fb82f2733f5297f', 'e@d.c', '2015-12-10', 'dddd', '(888) 777-8888');
